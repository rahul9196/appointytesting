...
describe('register new account', function(){
	...
	browser.get('https://business.appointy.com/account/register');
...
//		expect(element(by.xpath('//span[@class="hightlight"]')).getText()).toContain('https://booking.appointy.com')
		var congratstext = element(by.xpath('//h1[contains(concat(" ",@class," "),"text-center")]'))
		expect(congratstext.getText()).toBe('Congrats! We’ve reserved the following URL for you')
